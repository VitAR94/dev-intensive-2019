...
class Bender(var status:Status = Status.NORMAL, var question:Question = Question.NAME) {
    ...
    fun listenAnswer(answer:String):Pair<String,Triple<Int, Int, Int>>{
        val checkRes = question.checkValid(answer)
        return if (checkRes == null)
    ...
    enum class Question(val question:String, val answer:List<String>){
        NAME("Как меня зовут?", listOf("бендер", "bender")) {
            ...
            override fun checkValid(answer: String): String? {
        ...
        PROFESSION("Назови мою профессию?", listOf("сгибальщик", "bender")) {
            ...
            override fun checkValid(answer: String): String? {
                return if(answer.first().isUpperCase())"Профессия должна начинаться со строчной буквы" else null
            }
        },
        ...
        SERIAL("Мой серийный номер?", listOf("2716057")) {
            ...
            override fun checkValid(answer: String): String? {
                return if(!answer.matches("\\d{7}".toRegex())) "Серийный номер содержит только цифры, и их 7" else null
            }
        },
        ...
        abstract fun checkValid(answer:String):String?
    }
}